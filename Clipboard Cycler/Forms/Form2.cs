...
namespace Clipboard_Cycler
{
    public partial class Form2 : HotkeysExtensionForm
    {
        ...
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            Settings.Form2Fields[0] = textBox1.Text;
            Settings.Form2Fields[1] = textBox2.Text;
            Settings.Form2Fields[2] = textBox3.Text;
            Settings.Form2Fields[3] = textBox4.Text;
            Settings.Form2Fields[4] = textBox5.Text;
            Settings.Save();
            HotkeyComm?.Dispose();
            HotkeyComm = null;
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            MyRoundedButtons1.PaintButton(button2);
            ...
            textBox1.Text = Settings.Form2Fields[0];
            textBox2.Text = Settings.Form2Fields[1];
            textBox3.Text = Settings.Form2Fields[2];
